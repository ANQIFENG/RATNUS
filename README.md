...
**This branch (v2.0-ratnus_t1map)** is our updated version, which takes **T1 maps** as input, where we have validated that T1 maps offer optimal performance in thalamic nuclei segmentation. 
